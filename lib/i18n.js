...
export const translations = {
  en: {
    ...
    category: { dealsAndPromoCodes: 'deals and promo codes', noCodeNeeded: 'No code needed', ends: 'Ends', storesDirectory: 'Stores Directory', exploreStores: 'Explore premium stores and active offers', couponSystem: 'Coupon System', verifiedDeals: 'Verified deals across shopping, dining, travel, and entertainment' },
  ...
  es: {
    ...
    category: { dealsAndPromoCodes: 'ofertas y códigos promocionales', noCodeNeeded: 'No se necesita código', ends: 'Finaliza', storesDirectory: 'Directorio de tiendas', exploreStores: 'Explora tiendas premium y ofertas activas', couponSystem: 'Sistema de cupones', verifiedDeals: 'Ofertas verificadas en compras, restaurantes, viajes y entretenimiento' },
  ...
  he: {
    ...
    category: { dealsAndPromoCodes: 'מבצעים וקודי קופון', noCodeNeeded: 'לא נדרש קוד', ends: 'בתוקף עד', storesDirectory: 'מדריך חנויות', exploreStores: 'גלו חנויות פרימיום ומבצעים פעילים', couponSystem: 'מערכת קופונים', verifiedDeals: 'מבצעים מאומתים בקניות, מסעדות, נסיעות ובידור' },
  ...
  zh: {
    ...
    category: { dealsAndPromoCodes: '优惠与优惠码', noCodeNeeded: '无需代码', ends: '截止', storesDirectory: '商店目录', exploreStores: '探索高端商店和当前优惠', couponSystem: '优惠券系统', verifiedDeals: '购物、餐饮、旅行和娱乐领域的已验证优惠' },
  ...
  uk: {
    ...
    category: { dealsAndPromoCodes: 'знижки та промокоди', noCodeNeeded: 'Код не потрібен', ends: 'Діє до', storesDirectory: 'Каталог магазинів', exploreStores: 'Досліджуйте преміальні магазини та активні пропозиції', couponSystem: 'Система купонів', verifiedDeals: 'Перевірені знижки в шопінгу, ресторанах, подорожах і розвагах' },
  ...
  ja: {
    ...
    category: { dealsAndPromoCodes: 'お得情報とプロモコード', noCodeNeeded: 'コード不要', ends: '終了', storesDirectory: 'ストアディレクトリ', exploreStores: 'プレミアムストアと現在のオファーを探索', couponSystem: 'クーポンシステム', verifiedDeals: 'ショッピング、レストラン、旅行、エンターテインメントの確認済み特典' },
  ...
  ko: {
    ...
    category: { dealsAndPromoCodes: '혜택 및 프로모 코드', noCodeNeeded: '코드 필요 없음', ends: '종료', storesDirectory: '스토어 디렉토리', exploreStores: '프리미엄 스토어와 진행 중인 혜택을 살펴보세요', couponSystem: '쿠폰 시스템', verifiedDeals: '쇼핑, 레스토랑, 여행, 엔터테인먼트 분야의 검증된 혜택' },
  ...
  ar: {
    ...
    category: { dealsAndPromoCodes: 'عروض وأكواد خصم', noCodeNeeded: 'لا حاجة لكود', ends: 'ينتهي في', storesDirectory: 'دليل المتاجر', exploreStores: 'اكتشف متاجر مميزة وعروض نشطة', couponSystem: 'نظام القسائم', verifiedDeals: 'عروض موثوقة في التسوق والمطاعم والسفر والترفيه' },
  ...
  tr: {
    ...
    category: { dealsAndPromoCodes: 'fırsatlar ve promosyon kodları', noCodeNeeded: 'Kod gerekmiyor', ends: 'Bitiş', storesDirectory: 'Mağaza Dizini', exploreStores: 'Premium mağazaları ve aktif fırsatları keşfedin', couponSystem: 'Kupon Sistemi', verifiedDeals: 'Alışveriş, restoran, seyahat ve eğlencede doğrulanmış fırsatlar' },
  ...
  fa: {
    ...
    category: { dealsAndPromoCodes: 'پیشنهادها و کدهای تخفیف', noCodeNeeded: 'نیازی به کد نیست', ends: 'پایان', storesDirectory: 'فهرست فروشگاه‌ها', exploreStores: 'فروشگاه‌های ویژه و پیشنهادهای فعال را کشف کنید', couponSystem: 'سیستم کد تخفیف', verifiedDeals: 'تخفیف‌های تأییدشده در خرید، رستوران، سفر و سرگرمی' },
  ...
  pl: {
    ...
    category: { dealsAndPromoCodes: 'oferty i kody promocyjne', noCodeNeeded: 'Kod niepotrzebny', ends: 'Kończy się', storesDirectory: 'Katalog sklepów', exploreStores: 'Odkryj sklepy premium i aktualne oferty', couponSystem: 'System kuponów', verifiedDeals: 'Zweryfikowane oferty w zakupach, restauracjach, podróżach i rozrywce' },
