...
export const translations = {
  en: {
    ...
    footer: { copyright: '© 2026 GORGONA ONE. Premium deals, verified offers, and affiliate-ready monetization.', privacy: 'Privacy', terms: 'Terms', disclosure: 'Disclosure', cookies: 'Cookies', partnerAgreement: 'Partner Agreement', admin: 'Admin' },
    admin: { badge: 'Protected Admin Dashboard', title: 'Manage stores, coupons, sportsbook offers, and analytics', addStores: 'Add stores', editCoupons: 'Edit coupons', deleteOffers: 'Delete offers', importCsv: 'Import CSV data' },
    promoPages: {
      aiReady: { badge: 'AI Ready', title: 'Future AI assistant infrastructure', body: 'The deal database is structured for future AI recommendations, natural-language search, and conversational deal discovery.' },
      amazonPromoCodes: { badge: 'SEO Page', title: 'Amazon promo codes and hidden savings', body: 'Find curated Amazon deals, free shipping offers, and verified discount opportunities.' },
      bestShoppingDeals: { badge: 'SEO Landing Page', title: 'Best shopping deals curated for premium savings', body: 'Discover the latest verified offers across fashion, electronics, home, travel, and beauty.', browseStores: 'Browse Stores' },
      betmgmPromos: { badge: 'SEO Page', title: 'BetMGM promos and sportsbook insights', body: 'A dedicated landing page for BetMGM offers, state access, and related information.' },
      caesarsPromos: { badge: 'SEO Page', title: 'Caesars Sportsbook promos and operator details', body: 'A dedicated page for Caesars Sportsbook offers and future-ready promo code information.' },
      draftkingsPromos: { badge: 'SEO Page', title: 'DraftKings promos and sportsbook updates', body: 'A dedicated page for DraftKings-related offers and operator information.' },
      fanduelPromos: { badge: 'SEO Page', title: 'FanDuel promos and betting updates', body: 'A dedicated page for FanDuel sportsbook promotions and operator details.' },
      fashionDiscounts: { badge: 'SEO Page', title: 'Fashion discounts for premium brands and seasonal drops', body: 'Browse fashion offers that combine style, quality, and limited-time promotions.' },
      nikeCoupons: { badge: 'SEO Page', title: 'Nike coupons and premium athlete essentials', body: 'Explore verified Nike offers, seasonal drops, and premium apparel discounts.' },
      sportsBettingPromos: { badge: 'SEO Page', title: 'Sports betting promos and sportsbook offers', body: 'Discover premium sportsbook-related content, state availability, and responsible-gambling guidance.' }
    },
    inquiryForm: { name: 'Name', phone: 'Phone number', email: 'Email', preferredDates: 'Preferred dates' }
  },
  ru: {
    ...
    footer: { copyright: '© 2026 GORGONA ONE. Премиальные предложения, проверенные акции и монетизация, готовая для партнёрских программ.', privacy: 'Конфиденциальность', terms: 'Условия', disclosure: 'Раскрытие информации', cookies: 'Cookie', partnerAgreement: 'Партнёрское соглашение', admin: 'Админ' },
    admin: { badge: 'Защищённая панель администратора', title: 'Управляйте магазинами, купонами, предложениями букмекеров и аналитикой', addStores: 'Добавить магазины', editCoupons: 'Редактировать купоны', deleteOffers: 'Удалить предложения', importCsv: 'Импорт данных CSV' },
    promoPages: {
      aiReady: { badge: 'Готово к ИИ', title: 'Инфраструктура для будущего ИИ-ассистента', body: 'База данных предложений структурирована для будущих ИИ-рекомендаций, поиска на естественном языке и диалогового поиска предложений.' },
      amazonPromoCodes: { badge: 'SEO-страница', title: 'Промокоды Amazon и скрытая экономия', body: 'Находите подобранные предложения Amazon, бесплатную доставку и проверенные скидки.' },
      bestShoppingDeals: { badge: 'SEO-целевая страница', title: 'Лучшие предложения для шопинга, подобранные для премиальной экономии', body: 'Открывайте новейшие проверенные предложения в моде, электронике, товарах для дома, путешествиях и красоте.', browseStores: 'Смотреть магазины' },
      betmgmPromos: { badge: 'SEO-страница', title: 'Промоакции BetMGM и обзор букмекера', body: 'Отдельная страница с предложениями BetMGM, доступностью по штатам и связанной информацией.' },
      caesarsPromos: { badge: 'SEO-страница', title: 'Промоакции Caesars Sportsbook и данные оператора', body: 'Отдельная страница с предложениями Caesars Sportsbook и информацией о будущих промокодах.' },
      draftkingsPromos: { badge: 'SEO-страница', title: 'Промоакции DraftKings и новости букмекера', body: 'Отдельная страница с предложениями DraftKings и информацией об операторе.' },
      fanduelPromos: { badge: 'SEO-страница', title: 'Промоакции FanDuel и новости ставок', body: 'Отдельная страница с промоакциями букмекера FanDuel и информацией об операторе.' },
      fashionDiscounts: { badge: 'SEO-страница', title: 'Скидки на модную одежду премиальных брендов и сезонные коллекции', body: 'Просматривайте модные предложения, сочетающие стиль, качество и ограниченные по времени акции.' },
      nikeCoupons: { badge: 'SEO-страница', title: 'Купоны Nike и премиальные вещи для спортсменов', body: 'Изучайте проверенные предложения Nike, сезонные коллекции и скидки на премиальную одежду.' },
      sportsBettingPromos: { badge: 'SEO-страница', title: 'Промоакции спортивных ставок и предложения букмекеров', body: 'Открывайте премиальный контент о букмекерах, доступности по штатам и рекомендации по ответственной игре.' }
    },
    inquiryForm: { name: 'Имя', phone: 'Номер телефона', email: 'Email', preferredDates: 'Предпочитаемые даты' }
  },
  es: {
    ...
    footer: { copyright: '© 2026 GORGONA ONE. Ofertas premium, promociones verificadas y monetización lista para afiliados.', privacy: 'Privacidad', terms: 'Términos', disclosure: 'Divulgación', cookies: 'Cookies', partnerAgreement: 'Acuerdo de socios', admin: 'Administración' },
    admin: { badge: 'Panel de administración protegido', title: 'Gestiona tiendas, cupones, ofertas de apuestas deportivas y analíticas', addStores: 'Agregar tiendas', editCoupons: 'Editar cupones', deleteOffers: 'Eliminar ofertas', importCsv: 'Importar datos CSV' },
    promoPages: {
      aiReady: { badge: 'Listo para IA', title: 'Infraestructura futura de asistente de IA', body: 'La base de datos de ofertas está estructurada para futuras recomendaciones de IA, búsqueda en lenguaje natural y descubrimiento conversacional de ofertas.' },
      amazonPromoCodes: { badge: 'Página SEO', title: 'Códigos promocionales de Amazon y ahorros ocultos', body: 'Encuentra ofertas seleccionadas de Amazon, envío gratis y oportunidades de descuento verificadas.' },
      bestShoppingDeals: { badge: 'Página de destino SEO', title: 'Las mejores ofertas de compras seleccionadas para un ahorro premium', body: 'Descubre las últimas ofertas verificadas en moda, electrónica, hogar, viajes y belleza.', browseStores: 'Explorar tiendas' },
      betmgmPromos: { badge: 'Página SEO', title: 'Promociones de BetMGM e información sobre la casa de apuestas', body: 'Una página dedicada a las ofertas de BetMGM, disponibilidad por estado e información relacionada.' },
      caesarsPromos: { badge: 'Página SEO', title: 'Promociones de Caesars Sportsbook y detalles del operador', body: 'Una página dedicada a las ofertas de Caesars Sportsbook e información sobre futuros códigos promocionales.' },
      draftkingsPromos: { badge: 'Página SEO', title: 'Promociones de DraftKings y novedades de apuestas deportivas', body: 'Una página dedicada a las ofertas relacionadas con DraftKings e información del operador.' },
      fanduelPromos: { badge: 'Página SEO', title: 'Promociones de FanDuel y novedades de apuestas', body: 'Una página dedicada a las promociones de la casa de apuestas FanDuel e información del operador.' },
      fashionDiscounts: { badge: 'Página SEO', title: 'Descuentos de moda en marcas premium y lanzamientos de temporada', body: 'Explora ofertas de moda que combinan estilo, calidad y promociones por tiempo limitado.' },
      nikeCoupons: { badge: 'Página SEO', title: 'Cupones de Nike y esenciales premium para atletas', body: 'Explora ofertas verificadas de Nike, lanzamientos de temporada y descuentos en ropa premium.' },
      sportsBettingPromos: { badge: 'Página SEO', title: 'Promociones de apuestas deportivas y ofertas de casas de apuestas', body: 'Descubre contenido premium relacionado con casas de apuestas, disponibilidad por estado y orientación sobre el juego responsable.' }
    },
    inquiryForm: { name: 'Nombre', phone: 'Número de teléfono', email: 'Correo electrónico', preferredDates: 'Fechas preferidas' }
  },
  he: {
    ...
    footer: { copyright: '© 2026 GORGONA ONE. מבצעים פרימיום, הצעות מאומתות ומונטיזציה מוכנה לשותפים.', privacy: 'פרטיות', terms: 'תנאים', disclosure: 'גילוי נאות', cookies: 'עוגיות', partnerAgreement: 'הסכם שותפים', admin: 'ניהול' },
    admin: { badge: 'לוח בקרה מוגן למנהל', title: 'נהל חנויות, קופונים, הצעות הימורי ספורט וניתוח נתונים', addStores: 'הוספת חנויות', editCoupons: 'עריכת קופונים', deleteOffers: 'מחיקת מבצעים', importCsv: 'ייבוא נתוני CSV' },
    promoPages: {
      aiReady: { badge: 'מוכן ל-AI', title: 'תשתית עתידית לעוזר בינה מלאכותית', body: 'מסד הנתונים של המבצעים בנוי עבור המלצות AI עתידיות, חיפוש בשפה טבעית וגילוי מבצעים בשיחה.' },
      amazonPromoCodes: { badge: 'עמוד SEO', title: 'קודי קופון של Amazon וחיסכון נסתר', body: 'מצאו מבצעי Amazon נבחרים, הצעות משלוח חינם והזדמנויות הנחה מאומתות.' },
      bestShoppingDeals: { badge: 'עמוד נחיתה SEO', title: 'מבצעי הקניות הטובים ביותר, נבחרים לחיסכון פרימיום', body: 'גלו את המבצעים המאומתים העדכניים ביותר באופנה, אלקטרוניקה, בית, נסיעות ויופי.', browseStores: 'עיון בחנויות' },
      betmgmPromos: { badge: 'עמוד SEO', title: 'מבצעי BetMGM ותובנות על ההימורים', body: 'עמוד ייעודי למבצעי BetMGM, זמינות לפי מדינה ומידע קשור.' },
      caesarsPromos: { badge: 'עמוד SEO', title: 'מבצעי Caesars Sportsbook ופרטי המפעיל', body: 'עמוד ייעודי למבצעי Caesars Sportsbook ומידע עתידי על קודי קופון.' },
      draftkingsPromos: { badge: 'עמוד SEO', title: 'מבצעי DraftKings ועדכוני הימורי ספורט', body: 'עמוד ייעודי למבצעים הקשורים ל-DraftKings ומידע על המפעיל.' },
      fanduelPromos: { badge: 'עמוד SEO', title: 'מבצעי FanDuel ועדכוני הימורים', body: 'עמוד ייעודי למבצעי הימורי הספורט של FanDuel ופרטי המפעיל.' },
      fashionDiscounts: { badge: 'עמוד SEO', title: 'הנחות אופנה למותגי פרימיום ולקולקציות עונתיות', body: 'עיינו במבצעי אופנה המשלבים סגנון, איכות ומבצעים לזמן מוגבל.' },
      nikeCoupons: { badge: 'עמוד SEO', title: 'קופוני Nike ופריטי בסיס פרימיום לספורטאים', body: 'גלו מבצעי Nike מאומתים, קולקציות עונתיות והנחות על ביגוד פרימיום.' },
      sportsBettingPromos: { badge: 'עמוד SEO', title: 'מבצעי הימורי ספורט והצעות בתי הימורים', body: 'גלו תוכן פרימיום על בתי הימורים, זמינות לפי מדינה והנחיות להימורים אחראיים.' }
    },
    inquiryForm: { name: 'שם', phone: 'מספר טלפון', email: 'אימייל', preferredDates: 'תאריכים מועדפים' }
  },
  zh: {
    ...
    footer: { copyright: '© 2026 GORGONA ONE。优质优惠、已验证的活动，以及适合联盟营销的变现方案。', privacy: '隐私政策', terms: '条款', disclosure: '披露', cookies: 'Cookie', partnerAgreement: '合作伙伴协议', admin: '管理后台' },
    admin: { badge: '受保护的管理后台', title: '管理商店、优惠券、博彩优惠和数据分析', addStores: '添加商店', editCoupons: '编辑优惠券', deleteOffers: '删除优惠', importCsv: '导入CSV数据' },
    promoPages: {
      aiReady: { badge: 'AI就绪', title: '面向未来的AI助手基础设施', body: '优惠数据库的结构支持未来的AI推荐、自然语言搜索和对话式优惠发现。' },
      amazonPromoCodes: { badge: 'SEO页面', title: '亚马逊促销码与隐藏优惠', body: '发现精选的亚马逊优惠、免运费活动和已验证的折扣机会。' },
      bestShoppingDeals: { badge: 'SEO落地页', title: '为高端省钱精选的最佳购物优惠', body: '发现时尚、电子产品、家居、旅行和美妆领域的最新已验证优惠。', browseStores: '浏览商店' },
      betmgmPromos: { badge: 'SEO页面', title: 'BetMGM促销与博彩公司信息', body: '专门介绍BetMGM优惠、各州准入情况及相关信息的落地页。' },
      caesarsPromos: { badge: 'SEO页面', title: 'Caesars Sportsbook促销与运营商详情', body: '专门介绍Caesars Sportsbook优惠以及未来促销码信息的页面。' },
      draftkingsPromos: { badge: 'SEO页面', title: 'DraftKings促销与博彩动态', body: '专门介绍DraftKings相关优惠和运营商信息的页面。' },
      fanduelPromos: { badge: 'SEO页面', title: 'FanDuel促销与投注动态', body: '专门介绍FanDuel博彩促销和运营商详情的页面。' },
      fashionDiscounts: { badge: 'SEO页面', title: '高端品牌与季节新品的时尚折扣', body: '浏览兼具风格、品质和限时促销的时尚优惠。' },
      nikeCoupons: { badge: 'SEO页面', title: 'Nike优惠券与高端运动必需品', body: '探索已验证的Nike优惠、季节新品及高端服饰折扣。' },
      sportsBettingPromos: { badge: 'SEO页面', title: '体育博彩促销与博彩公司优惠', body: '探索高端博彩相关内容、各州准入情况及负责任博彩指引。' }
    },
    inquiryForm: { name: '姓名', phone: '电话号码', email: '电子邮箱', preferredDates: '偏好日期' }
  },
  pt: {
    ...
    footer: { copyright: '© 2026 GORGONA ONE. Ofertas premium, promoções verificadas e monetização pronta para afiliados.', privacy: 'Privacidade', terms: 'Termos', disclosure: 'Divulgação', cookies: 'Cookies', partnerAgreement: 'Acordo de parceria', admin: 'Administração' },
    admin: { badge: 'Painel administrativo protegido', title: 'Gerencie lojas, cupons, ofertas de apostas esportivas e análises', addStores: 'Adicionar lojas', editCoupons: 'Editar cupons', deleteOffers: 'Excluir ofertas', importCsv: 'Importar dados CSV' },
    promoPages: {
      aiReady: { badge: 'Pronto para IA', title: 'Infraestrutura futura de assistente de IA', body: 'O banco de dados de ofertas está estruturado para futuras recomendações de IA, busca em linguagem natural e descoberta conversacional de ofertas.' },
      amazonPromoCodes: { badge: 'Página SEO', title: 'Códigos promocionais da Amazon e economias ocultas', body: 'Encontre ofertas selecionadas da Amazon, frete grátis e oportunidades de desconto verificadas.' },
      bestShoppingDeals: { badge: 'Página de destino SEO', title: 'As melhores ofertas de compras selecionadas para economia premium', body: 'Descubra as ofertas verificadas mais recentes em moda, eletrônicos, casa, viagens e beleza.', browseStores: 'Ver lojas' },
      betmgmPromos: { badge: 'Página SEO', title: 'Promoções da BetMGM e informações sobre a casa de apostas', body: 'Uma página dedicada às ofertas da BetMGM, disponibilidade por estado e informações relacionadas.' },
      caesarsPromos: { badge: 'Página SEO', title: 'Promoções da Caesars Sportsbook e detalhes do operador', body: 'Uma página dedicada às ofertas da Caesars Sportsbook e informações futuras sobre códigos promocionais.' },
      draftkingsPromos: { badge: 'Página SEO', title: 'Promoções da DraftKings e novidades de apostas esportivas', body: 'Uma página dedicada às ofertas relacionadas à DraftKings e informações sobre o operador.' },
      fanduelPromos: { badge: 'Página SEO', title: 'Promoções da FanDuel e novidades de apostas', body: 'Uma página dedicada às promoções da casa de apostas FanDuel e detalhes do operador.' },
      fashionDiscounts: { badge: 'Página SEO', title: 'Descontos de moda em marcas premium e lançamentos sazonais', body: 'Explore ofertas de moda que combinam estilo, qualidade e promoções por tempo limitado.' },
      nikeCoupons: { badge: 'Página SEO', title: 'Cupons Nike e itens essenciais premium para atletas', body: 'Explore ofertas verificadas da Nike, lançamentos sazonais e descontos em roupas premium.' },
      sportsBettingPromos: { badge: 'Página SEO', title: 'Promoções de apostas esportivas e ofertas de casas de apostas', body: 'Descubra conteúdo premium relacionado a casas de apostas, disponibilidade por estado e orientações sobre jogo responsável.' }
    },
    inquiryForm: { name: 'Nome', phone: 'Número de telefone', email: 'E-mail', preferredDates: 'Datas preferidas' }
  },
  uk: {
    ...
    footer: { copyright: '© 2026 GORGONA ONE. Преміальні пропозиції, перевірені акції та монетизація, готова для партнерських програм.', privacy: 'Конфіденційність', terms: 'Умови', disclosure: 'Розкриття інформації', cookies: 'Файли cookie', partnerAgreement: 'Партнерська угода', admin: 'Адмін' },
    admin: { badge: 'Захищена панель адміністратора', title: 'Керуйте магазинами, купонами, пропозиціями букмекерів та аналітикою', addStores: 'Додати магазини', editCoupons: 'Редагувати купони', deleteOffers: 'Видалити пропозиції', importCsv: 'Імпорт даних CSV' },
    promoPages: {
      aiReady: { badge: 'Готово до ШІ', title: 'Майбутня інфраструктура ШІ-асистента', body: 'База даних пропозицій структурована для майбутніх рекомендацій ШІ, пошуку природною мовою та розмовного пошуку пропозицій.' },
      amazonPromoCodes: { badge: 'SEO-сторінка', title: 'Промокоди Amazon та прихована економія', body: 'Знаходьте підібрані пропозиції Amazon, безкоштовну доставку та перевірені знижки.' },
      bestShoppingDeals: { badge: 'SEO-цільова сторінка', title: 'Найкращі пропозиції для шопінгу, підібрані для преміальної економії', body: 'Відкривайте найновіші перевірені пропозиції в моді, електроніці, товарах для дому, подорожах і красі.', browseStores: 'Переглянути магазини' },
      betmgmPromos: { badge: 'SEO-сторінка', title: 'Промоакції BetMGM та огляд букмекера', body: 'Окрема сторінка з пропозиціями BetMGM, доступністю за штатами та пов’язаною інформацією.' },
      caesarsPromos: { badge: 'SEO-сторінка', title: 'Промоакції Caesars Sportsbook та дані оператора', body: 'Окрема сторінка з пропозиціями Caesars Sportsbook та інформацією про майбутні промокоди.' },
      draftkingsPromos: { badge: 'SEO-сторінка', title: 'Промоакції DraftKings та новини букмекера', body: 'Окрема сторінка з пропозиціями DraftKings та інформацією про оператора.' },
      fanduelPromos: { badge: 'SEO-сторінка', title: 'Промоакції FanDuel та новини ставок', body: 'Окрема сторінка з промоакціями букмекера FanDuel та інформацією про оператора.' },
      fashionDiscounts: { badge: 'SEO-сторінка', title: 'Знижки на модний одяг преміальних брендів і сезонні колекції', body: 'Переглядайте модні пропозиції, що поєднують стиль, якість та обмежені за часом акції.' },
      nikeCoupons: { badge: 'SEO-сторінка', title: 'Купони Nike та преміальні речі для спортсменів', body: 'Вивчайте перевірені пропозиції Nike, сезонні колекції та знижки на преміальний одяг.' },
      sportsBettingPromos: { badge: 'SEO-сторінка', title: 'Промоакції спортивних ставок та пропозиції букмекерів', body: 'Відкривайте преміальний контент про букмекерів, доступність за штатами та поради щодо відповідальної гри.' }
    },
    inquiryForm: { name: 'Ім’я', phone: 'Номер телефону', email: 'Email', preferredDates: 'Бажані дати' }
  },
  ja: {
    ...
    footer: { copyright: '© 2026 GORGONA ONE。プレミアムなお得情報、確認済みのオファー、アフィリエイト対応の収益化。', privacy: 'プライバシー', terms: '利用規約', disclosure: '開示事項', cookies: 'クッキー', partnerAgreement: 'パートナー契約', admin: '管理者' },
    admin: { badge: '保護された管理者ダッシュボード', title: 'ストア、クーポン、スポーツブックのオファー、分析を管理', addStores: 'ストアを追加', editCoupons: 'クーポンを編集', deleteOffers: 'オファーを削除', importCsv: 'CSVデータをインポート' },
    promoPages: {
      aiReady: { badge: 'AI対応', title: '将来のAIアシスタント基盤', body: 'お得情報データベースは、将来のAIレコメンデーション、自然言語検索、会話型のお得情報発見に対応できるよう設計されています。' },
      amazonPromoCodes: { badge: 'SEOページ', title: 'Amazonのプロモコードと隠れたお得情報', body: '厳選されたAmazonのお得情報、送料無料オファー、確認済みの割引機会を見つけましょう。' },
      bestShoppingDeals: { badge: 'SEOランディングページ', title: 'プレミアムな節約のために厳選された最高のショッピングお得情報', body: 'ファッション、家電、ホーム、旅行、美容の最新の確認済みオファーを発見しましょう。', browseStores: 'ストアを見る' },
      betmgmPromos: { badge: 'SEOページ', title: 'BetMGMのプロモとスポーツブック情報', body: 'BetMGMのオファー、州別対応状況、関連情報を紹介する専用ページ。' },
      caesarsPromos: { badge: 'SEOページ', title: 'Caesars Sportsbookのプロモと運営情報', body: 'Caesars Sportsbookのオファーと今後のプロモコード情報を紹介する専用ページ。' },
      draftkingsPromos: { badge: 'SEOページ', title: 'DraftKingsのプロモとスポーツブック最新情報', body: 'DraftKings関連のオファーと運営情報を紹介する専用ページ。' },
      fanduelPromos: { badge: 'SEOページ', title: 'FanDuelのプロモとベッティング最新情報', body: 'FanDuelスポーツブックのプロモーションと運営情報を紹介する専用ページ。' },
      fashionDiscounts: { badge: 'SEOページ', title: 'プレミアムブランドとシーズン新作のファッション割引', body: 'スタイル、品質、期間限定プロモーションを兼ね備えたファッションオファーをご覧ください。' },
      nikeCoupons: { badge: 'SEOページ', title: 'Nikeクーポンとプレミアムなアスリート必需品', body: '確認済みのNikeオファー、シーズン新作、プレミアムアパレルの割引をご覧ください。' },
      sportsBettingPromos: { badge: 'SEOページ', title: 'スポーツベッティングのプロモとスポーツブックのオファー', body: 'プレミアムなスポーツブック関連コンテンツ、州別対応状況、責任あるギャンブルへのガイダンスを紹介します。' }
    },
    inquiryForm: { name: '名前', phone: '電話番号', email: 'メールアドレス', preferredDates: '希望日' }
  },
  ko: {
    ...
    footer: { copyright: '© 2026 GORGONA ONE. 프리미엄 혜택, 검증된 오퍼, 제휴 마케팅에 최적화된 수익화.', privacy: '개인정보 보호정책', terms: '이용약관', disclosure: '공개 정보', cookies: '쿠키', partnerAgreement: '파트너 계약', admin: '관리자' },
    admin: { badge: '보호된 관리자 대시보드', title: '스토어, 쿠폰, 스포츠북 오퍼 및 분석 관리', addStores: '스토어 추가', editCoupons: '쿠폰 편집', deleteOffers: '오퍼 삭제', importCsv: 'CSV 데이터 가져오기' },
    promoPages: {
      aiReady: { badge: 'AI 준비 완료', title: '미래 AI 어시스턴트 인프라', body: '혜택 데이터베이스는 향후 AI 추천, 자연어 검색, 대화형 혜택 탐색을 위해 구조화되어 있습니다.' },
      amazonPromoCodes: { badge: 'SEO 페이지', title: '아마존 프로모 코드와 숨겨진 절약 혜택', body: '엄선된 아마존 혜택, 무료 배송 오퍼, 검증된 할인 기회를 찾아보세요.' },
      bestShoppingDeals: { badge: 'SEO 랜딩 페이지', title: '프리미엄 절약을 위해 엄선된 최고의 쇼핑 혜택', body: '패션, 전자제품, 홈, 여행, 뷰티 분야의 최신 검증된 혜택을 발견하세요.', browseStores: '스토어 둘러보기' },
      betmgmPromos: { badge: 'SEO 페이지', title: 'BetMGM 프로모와 스포츠북 정보', body: 'BetMGM 혜택, 주별 이용 가능 여부 및 관련 정보를 소개하는 전용 페이지입니다.' },
      caesarsPromos: { badge: 'SEO 페이지', title: 'Caesars Sportsbook 프로모와 운영사 세부 정보', body: 'Caesars Sportsbook 혜택과 향후 프로모 코드 정보를 소개하는 전용 페이지입니다.' },
      draftkingsPromos: { badge: 'SEO 페이지', title: 'DraftKings 프로모와 스포츠북 소식', body: 'DraftKings 관련 혜택과 운영사 정보를 소개하는 전용 페이지입니다.' },
      fanduelPromos: { badge: 'SEO 페이지', title: 'FanDuel 프로모와 베팅 소식', body: 'FanDuel 스포츠북 프로모션과 운영사 세부 정보를 소개하는 전용 페이지입니다.' },
      fashionDiscounts: { badge: 'SEO 페이지', title: '프리미엄 브랜드와 시즌 신상품의 패션 할인', body: '스타일, 품질, 기간 한정 프로모션을 결합한 패션 혜택을 둘러보세요.' },
      nikeCoupons: { badge: 'SEO 페이지', title: 'Nike 쿠폰과 프리미엄 애슬리트 필수템', body: '검증된 Nike 혜택, 시즌 신상품, 프리미엄 의류 할인을 살펴보세요.' },
      sportsBettingPromos: { badge: 'SEO 페이지', title: '스포츠 베팅 프로모와 스포츠북 혜택', body: '프리미엄 스포츠북 관련 콘텐츠, 주별 이용 가능 여부, 책임감 있는 베팅 가이드를 확인하세요.' }
    },
    inquiryForm: { name: '이름', phone: '전화번호', email: '이메일', preferredDates: '희망 날짜' }
  },
  de: {
    ...
    footer: { copyright: '© 2026 GORGONA ONE. Premium-Angebote, verifizierte Aktionen und affiliate-taugliche Monetarisierung.', privacy: 'Datenschutz', terms: 'Nutzungsbedingungen', disclosure: 'Offenlegung', cookies: 'Cookies', partnerAgreement: 'Partnervereinbarung', admin: 'Verwaltung' },
    admin: { badge: 'Geschütztes Admin-Dashboard', title: 'Verwalten Sie Shops, Gutscheine, Sportwetten-Angebote und Analysen', addStores: 'Shops hinzufügen', editCoupons: 'Gutscheine bearbeiten', deleteOffers: 'Angebote löschen', importCsv: 'CSV-Daten importieren' },
    promoPages: {
      aiReady: { badge: 'KI-bereit', title: 'Zukünftige KI-Assistenten-Infrastruktur', body: 'Die Angebotsdatenbank ist für zukünftige KI-Empfehlungen, Suche in natürlicher Sprache und dialogbasierte Angebotsentdeckung strukturiert.' },
      amazonPromoCodes: { badge: 'SEO-Seite', title: 'Amazon-Gutscheincodes und versteckte Ersparnisse', body: 'Finden Sie kuratierte Amazon-Angebote, kostenlose Versandangebote und verifizierte Rabattmöglichkeiten.' },
      bestShoppingDeals: { badge: 'SEO-Landingpage', title: 'Beste Shopping-Angebote, kuratiert für Premium-Ersparnisse', body: 'Entdecken Sie die neuesten verifizierten Angebote in Mode, Elektronik, Zuhause, Reisen und Beauty.', browseStores: 'Shops durchsuchen' },
      betmgmPromos: { badge: 'SEO-Seite', title: 'BetMGM-Promotionen und Sportwetten-Einblicke', body: 'Eine eigene Landingpage für BetMGM-Angebote, Verfügbarkeit nach Bundesstaat und verwandte Informationen.' },
      caesarsPromos: { badge: 'SEO-Seite', title: 'Caesars Sportsbook-Promotionen und Betreiberdetails', body: 'Eine eigene Seite für Caesars Sportsbook-Angebote und zukunftsfähige Gutscheincode-Informationen.' },
      draftkingsPromos: { badge: 'SEO-Seite', title: 'DraftKings-Promotionen und Sportwetten-Updates', body: 'Eine eigene Seite für DraftKings-bezogene Angebote und Betreiberinformationen.' },
      fanduelPromos: { badge: 'SEO-Seite', title: 'FanDuel-Promotionen und Wett-Updates', body: 'Eine eigene Seite für FanDuel-Sportwetten-Promotionen und Betreiberdetails.' },
      fashionDiscounts: { badge: 'SEO-Seite', title: 'Modedrabatte für Premium-Marken und saisonale Neuheiten', body: 'Entdecken Sie Modeangebote, die Stil, Qualität und zeitlich begrenzte Promotionen vereinen.' },
      nikeCoupons: { badge: 'SEO-Seite', title: 'Nike-Gutscheine und Premium-Essentials für Athleten', body: 'Entdecken Sie verifizierte Nike-Angebote, saisonale Neuheiten und Rabatte auf Premium-Bekleidung.' },
      sportsBettingPromos: { badge: 'SEO-Seite', title: 'Sportwetten-Promotionen und Sportwettenanbieter-Angebote', body: 'Entdecken Sie Premium-Inhalte rund um Sportwettenanbieter, Verfügbarkeit nach Bundesstaat und Hinweise zu verantwortungsvollem Glücksspiel.' }
    },
    inquiryForm: { name: 'Name', phone: 'Telefonnummer', email: 'E-Mail', preferredDates: 'Bevorzugte Termine' }
  },
  ar: {
    ...
    footer: { copyright: '© 2026 GORGONA ONE. عروض مميزة، صفقات موثقة، وربحية جاهزة لبرامج التسويق بالعمولة.', privacy: 'الخصوصية', terms: 'الشروط', disclosure: 'الإفصاح', cookies: 'ملفات تعريف الارتباط', partnerAgreement: 'اتفاقية الشراكة', admin: 'الإدارة' },
    admin: { badge: 'لوحة تحكم إدارية محمية', title: 'إدارة المتاجر والقسائم وعروض الرهان الرياضي والتحليلات', addStores: 'إضافة متاجر', editCoupons: 'تعديل القسائم', deleteOffers: 'حذف العروض', importCsv: 'استيراد بيانات CSV' },
    promoPages: {
      aiReady: { badge: 'جاهز للذكاء الاصطناعي', title: 'بنية تحتية مستقبلية لمساعد الذكاء الاصطناعي', body: 'قاعدة بيانات العروض مُصممة لدعم توصيات الذكاء الاصطناعي المستقبلية، والبحث باللغة الطبيعية، واكتشاف العروض عبر المحادثة.' },
      amazonPromoCodes: { badge: 'صفحة SEO', title: 'أكواد خصم أمازون ووفورات خفية', body: 'اعثر على عروض أمازون المنتقاة، وعروض الشحن المجاني، وفرص الخصم الموثقة.' },
      bestShoppingDeals: { badge: 'صفحة هبوط SEO', title: 'أفضل عروض التسوق المنتقاة لوفورات مميزة', body: 'اكتشف أحدث العروض الموثقة في الموضة والإلكترونيات والمنزل والسفر والجمال.', browseStores: 'تصفح المتاجر' },
      betmgmPromos: { badge: 'صفحة SEO', title: 'عروض BetMGM ونظرة عامة على منصة الرهان', body: 'صفحة مخصصة لعروض BetMGM وإمكانية الوصول حسب الولاية ومعلومات ذات صلة.' },
      caesarsPromos: { badge: 'صفحة SEO', title: 'عروض Caesars Sportsbook وتفاصيل المُشغّل', body: 'صفحة مخصصة لعروض Caesars Sportsbook ومعلومات أكواد الخصم المستقبلية.' },
      draftkingsPromos: { badge: 'صفحة SEO', title: 'عروض DraftKings وتحديثات منصة الرهان', body: 'صفحة مخصصة للعروض المتعلقة بـ DraftKings ومعلومات المُشغّل.' },
      fanduelPromos: { badge: 'صفحة SEO', title: 'عروض FanDuel وتحديثات الرهان', body: 'صفحة مخصصة لعروض منصة الرهان FanDuel وتفاصيل المُشغّل.' },
      fashionDiscounts: { badge: 'صفحة SEO', title: 'خصومات أزياء للماركات المميزة والإصدارات الموسمية', body: 'تصفح عروض الأزياء التي تجمع بين الأناقة والجودة والعروض محدودة المدة.' },
      nikeCoupons: { badge: 'صفحة SEO', title: 'كوبونات Nike وأساسيات الرياضيين المميزة', body: 'اكتشف عروض Nike الموثقة، والإصدارات الموسمية، وخصومات الملابس المميزة.' },
      sportsBettingPromos: { badge: 'صفحة SEO', title: 'عروض الرهان الرياضي وعروض منصات الرهان', body: 'اكتشف محتوى مميزاً متعلقاً بمنصات الرهان، وإمكانية الوصول حسب الولاية، وإرشادات المراهنة المسؤولة.' }
    },
    inquiryForm: { name: 'الاسم', phone: 'رقم الهاتف', email: 'البريد الإلكتروني', preferredDates: 'التواريخ المفضلة' }
  },
  tr: {
    ...
    footer: { copyright: '© 2026 GORGONA ONE. Premium fırsatlar, doğrulanmış teklifler ve iş ortaklığına hazır gelir modeli.', privacy: 'Gizlilik', terms: 'Koşullar', disclosure: 'Açıklama', cookies: 'Çerezler', partnerAgreement: 'Ortaklık Sözleşmesi', admin: 'Yönetim' },
    admin: { badge: 'Korumalı Yönetici Paneli', title: 'Mağazaları, kuponları, bahis sitesi tekliflerini ve analitiği yönetin', addStores: 'Mağaza ekle', editCoupons: 'Kuponları düzenle', deleteOffers: 'Teklifleri sil', importCsv: 'CSV verisi içe aktar' },
    promoPages: {
      aiReady: { badge: 'Yapay Zekaya Hazır', title: 'Geleceğin yapay zeka asistanı altyapısı', body: 'Fırsat veritabanı, gelecekteki yapay zeka önerileri, doğal dil araması ve sohbet tabanlı fırsat keşfi için yapılandırılmıştır.' },
      amazonPromoCodes: { badge: 'SEO Sayfası', title: 'Amazon promosyon kodları ve gizli tasarruflar', body: 'Özenle seçilmiş Amazon fırsatlarını, ücretsiz kargo tekliflerini ve doğrulanmış indirim fırsatlarını bulun.' },
      bestShoppingDeals: { badge: 'SEO Açılış Sayfası', title: 'Premium tasarruf için özenle seçilmiş en iyi alışveriş fırsatları', body: 'Moda, elektronik, ev, seyahat ve güzellik alanlarındaki en yeni doğrulanmış teklifleri keşfedin.', browseStores: 'Mağazalara Göz At' },
      betmgmPromos: { badge: 'SEO Sayfası', title: 'BetMGM promosyonları ve bahis sitesi bilgileri', body: 'BetMGM teklifleri, eyalet erişimi ve ilgili bilgiler için özel bir açılış sayfası.' },
      caesarsPromos: { badge: 'SEO Sayfası', title: 'Caesars Sportsbook promosyonları ve operatör detayları', body: 'Caesars Sportsbook teklifleri ve gelecekteki promosyon kodu bilgileri için özel bir sayfa.' },
      draftkingsPromos: { badge: 'SEO Sayfası', title: 'DraftKings promosyonları ve bahis sitesi güncellemeleri', body: 'DraftKings ile ilgili teklifler ve operatör bilgileri için özel bir sayfa.' },
      fanduelPromos: { badge: 'SEO Sayfası', title: 'FanDuel promosyonları ve bahis güncellemeleri', body: 'FanDuel bahis sitesi promosyonları ve operatör detayları için özel bir sayfa.' },
      fashionDiscounts: { badge: 'SEO Sayfası', title: 'Premium markalar ve sezonluk ürünler için moda indirimleri', body: 'Stil, kalite ve sınırlı süreli promosyonları bir araya getiren moda tekliflerine göz atın.' },
      nikeCoupons: { badge: 'SEO Sayfası', title: 'Nike kuponları ve premium sporcu temel ürünleri', body: 'Doğrulanmış Nike tekliflerini, sezonluk ürünleri ve premium giyim indirimlerini keşfedin.' },
      sportsBettingPromos: { badge: 'SEO Sayfası', title: 'Spor bahis promosyonları ve bahis sitesi teklifleri', body: 'Premium bahis sitesi içeriğini, eyalet erişilebilirliğini ve sorumlu bahis rehberliğini keşfedin.' }
    },
    inquiryForm: { name: 'Ad', phone: 'Telefon numarası', email: 'E-posta', preferredDates: 'Tercih edilen tarihler' }
  },
  fa: {
    ...
    footer: { copyright: '© 2026 GORGONA ONE. پیشنهادهای ویژه، تخفیف‌های تأییدشده و کسب درآمد آماده برای همکاری در فروش.', privacy: 'حریم خصوصی', terms: 'شرایط', disclosure: 'افشای اطلاعات', cookies: 'کوکی‌ها', partnerAgreement: 'قرارداد همکاری', admin: 'مدیریت' },
    admin: { badge: 'داشبورد مدیریت محافظت‌شده', title: 'مدیریت فروشگاه‌ها، کدهای تخفیف، پیشنهادهای شرط‌بندی و تحلیل‌ها', addStores: 'افزودن فروشگاه', editCoupons: 'ویرایش کدهای تخفیف', deleteOffers: 'حذف پیشنهادها', importCsv: 'وارد کردن داده‌های CSV' },
    promoPages: {
      aiReady: { badge: 'آماده برای هوش مصنوعی', title: 'زیرساخت آینده دستیار هوش مصنوعی', body: 'پایگاه داده پیشنهادها برای توصیه‌های آینده هوش مصنوعی، جستجوی زبان طبیعی و کشف مکالمه‌ای پیشنهادها طراحی شده است.' },
      amazonPromoCodes: { badge: 'صفحه SEO', title: 'کدهای تخفیف آمازون و صرفه‌جویی‌های پنهان', body: 'پیشنهادهای منتخب آمازون، ارسال رایگان و فرصت‌های تخفیف تأییدشده را پیدا کنید.' },
      bestShoppingDeals: { badge: 'صفحه فرود SEO', title: 'بهترین پیشنهادهای خرید، منتخب برای صرفه‌جویی ویژه', body: 'جدیدترین پیشنهادهای تأییدشده در مد، الکترونیک، خانه، سفر و زیبایی را کشف کنید.', browseStores: 'مرور فروشگاه‌ها' },
      betmgmPromos: { badge: 'صفحه SEO', title: 'تبلیغات BetMGM و اطلاعات سایت شرط‌بندی', body: 'صفحه‌ای اختصاصی برای پیشنهادهای BetMGM، دسترسی بر اساس ایالت و اطلاعات مرتبط.' },
      caesarsPromos: { badge: 'صفحه SEO', title: 'تبلیغات Caesars Sportsbook و جزئیات اپراتور', body: 'صفحه‌ای اختصاصی برای پیشنهادهای Caesars Sportsbook و اطلاعات آینده کد تخفیف.' },
      draftkingsPromos: { badge: 'صفحه SEO', title: 'تبلیغات DraftKings و به‌روزرسانی‌های شرط‌بندی', body: 'صفحه‌ای اختصاصی برای پیشنهادهای مرتبط با DraftKings و اطلاعات اپراتور.' },
      fanduelPromos: { badge: 'صفحه SEO', title: 'تبلیغات FanDuel و به‌روزرسانی‌های شرط‌بندی', body: 'صفحه‌ای اختصاصی برای تبلیغات سایت شرط‌بندی FanDuel و جزئیات اپراتور.' },
      fashionDiscounts: { badge: 'صفحه SEO', title: 'تخفیف‌های مد برای برندهای ویژه و مجموعه‌های فصلی', body: 'پیشنهادهای مد را که سبک، کیفیت و تبلیغات محدود زمانی را ترکیب می‌کنند، مرور کنید.' },
      nikeCoupons: { badge: 'صفحه SEO', title: 'کدهای تخفیف نایک و اقلام ضروری ویژه ورزشکاران', body: 'پیشنهادهای تأییدشده نایک، مجموعه‌های فصلی و تخفیف‌های پوشاک ویژه را کشف کنید.' },
      sportsBettingPromos: { badge: 'صفحه SEO', title: 'تبلیغات شرط‌بندی ورزشی و پیشنهادهای سایت‌های شرط‌بندی', body: 'محتوای ویژه مرتبط با سایت‌های شرط‌بندی، دسترسی بر اساس ایالت و راهنمای شرط‌بندی مسئولانه را کشف کنید.' }
    },
    inquiryForm: { name: 'نام', phone: 'شماره تلفن', email: 'ایمیل', preferredDates: 'تاریخ‌های مورد نظر' }
  },
  it: {
    ...
    footer: { copyright: '© 2026 GORGONA ONE. Offerte premium, promozioni verificate e monetizzazione pronta per l’affiliazione.', privacy: 'Privacy', terms: 'Termini', disclosure: 'Divulgazione', cookies: 'Cookie', partnerAgreement: 'Accordo di partnership', admin: 'Amministrazione' },
    admin: { badge: 'Dashboard amministrativa protetta', title: 'Gestisci negozi, coupon, offerte di scommesse sportive e analisi', addStores: 'Aggiungi negozi', editCoupons: 'Modifica coupon', deleteOffers: 'Elimina offerte', importCsv: 'Importa dati CSV' },
    promoPages: {
      aiReady: { badge: 'Pronto per l’IA', title: 'Infrastruttura futura per assistente IA', body: 'Il database delle offerte è strutturato per future raccomandazioni IA, ricerca in linguaggio naturale e scoperta conversazionale delle offerte.' },
      amazonPromoCodes: { badge: 'Pagina SEO', title: 'Codici promozionali Amazon e risparmi nascosti', body: 'Trova offerte Amazon selezionate, spedizione gratuita e opportunità di sconto verificate.' },
      bestShoppingDeals: { badge: 'Landing page SEO', title: 'Le migliori offerte di shopping selezionate per un risparmio premium', body: 'Scopri le ultime offerte verificate in moda, elettronica, casa, viaggi e bellezza.', browseStores: 'Esplora i negozi' },
      betmgmPromos: { badge: 'Pagina SEO', title: 'Promozioni BetMGM e approfondimenti sul bookmaker', body: 'Una pagina dedicata alle offerte BetMGM, alla disponibilità per stato e alle informazioni correlate.' },
      caesarsPromos: { badge: 'Pagina SEO', title: 'Promozioni Caesars Sportsbook e dettagli sull’operatore', body: 'Una pagina dedicata alle offerte Caesars Sportsbook e alle informazioni sui futuri codici promozionali.' },
      draftkingsPromos: { badge: 'Pagina SEO', title: 'Promozioni DraftKings e aggiornamenti sulle scommesse sportive', body: 'Una pagina dedicata alle offerte relative a DraftKings e alle informazioni sull’operatore.' },
      fanduelPromos: { badge: 'Pagina SEO', title: 'Promozioni FanDuel e aggiornamenti sulle scommesse', body: 'Una pagina dedicata alle promozioni del bookmaker FanDuel e ai dettagli sull’operatore.' },
      fashionDiscounts: { badge: 'Pagina SEO', title: 'Sconti moda per marchi premium e uscite stagionali', body: 'Sfoglia offerte moda che uniscono stile, qualità e promozioni a tempo limitato.' },
      nikeCoupons: { badge: 'Pagina SEO', title: 'Coupon Nike ed essenziali premium per atleti', body: 'Scopri offerte Nike verificate, uscite stagionali e sconti su abbigliamento premium.' },
      sportsBettingPromos: { badge: 'Pagina SEO', title: 'Promozioni scommesse sportive e offerte dei bookmaker', body: 'Scopri contenuti premium relativi ai bookmaker, disponibilità per stato e indicazioni sul gioco responsabile.' }
    },
    inquiryForm: { name: 'Nome', phone: 'Numero di telefono', email: 'Email', preferredDates: 'Date preferite' }
  },
  fr: {
    ...
    footer: { copyright: '© 2026 GORGONA ONE. Offres premium, promotions vérifiées et monétisation prête pour l’affiliation.', privacy: 'Confidentialité', terms: 'Conditions', disclosure: 'Divulgation', cookies: 'Cookies', partnerAgreement: 'Accord de partenariat', admin: 'Administration' },
    admin: { badge: 'Tableau de bord administrateur protégé', title: 'Gérez les boutiques, les coupons, les offres de paris sportifs et les analyses', addStores: 'Ajouter des boutiques', editCoupons: 'Modifier les coupons', deleteOffers: 'Supprimer des offres', importCsv: 'Importer des données CSV' },
    promoPages: {
      aiReady: { badge: 'Prêt pour l’IA', title: 'Infrastructure future d’assistant IA', body: 'La base de données des offres est structurée pour de futures recommandations IA, la recherche en langage naturel et la découverte d’offres par conversation.' },
      amazonPromoCodes: { badge: 'Page SEO', title: 'Codes promo Amazon et économies cachées', body: 'Trouvez des offres Amazon sélectionnées, des offres de livraison gratuite et des opportunités de réduction vérifiées.' },
      bestShoppingDeals: { badge: 'Page de destination SEO', title: 'Meilleures offres de shopping sélectionnées pour des économies premium', body: 'Découvrez les dernières offres vérifiées en mode, électronique, maison, voyage et beauté.', browseStores: 'Parcourir les boutiques' },
      betmgmPromos: { badge: 'Page SEO', title: 'Promotions BetMGM et informations sur le bookmaker', body: 'Une page dédiée aux offres BetMGM, à la disponibilité par État et aux informations connexes.' },
      caesarsPromos: { badge: 'Page SEO', title: 'Promotions Caesars Sportsbook et détails sur l’opérateur', body: 'Une page dédiée aux offres Caesars Sportsbook et aux informations sur les futurs codes promo.' },
      draftkingsPromos: { badge: 'Page SEO', title: 'Promotions DraftKings et actualités des paris sportifs', body: 'Une page dédiée aux offres liées à DraftKings et aux informations sur l’opérateur.' },
      fanduelPromos: { badge: 'Page SEO', title: 'Promotions FanDuel et actualités des paris', body: 'Une page dédiée aux promotions du bookmaker FanDuel et aux détails sur l’opérateur.' },
      fashionDiscounts: { badge: 'Page SEO', title: 'Réductions mode sur les marques premium et les nouveautés saisonnières', body: 'Parcourez des offres mode alliant style, qualité et promotions à durée limitée.' },
      nikeCoupons: { badge: 'Page SEO', title: 'Coupons Nike et essentiels premium pour athlètes', body: 'Découvrez des offres Nike vérifiées, des nouveautés saisonnières et des réductions sur les vêtements premium.' },
      sportsBettingPromos: { badge: 'Page SEO', title: 'Promotions de paris sportifs et offres des bookmakers', body: 'Découvrez du contenu premium lié aux bookmakers, la disponibilité par État et des conseils pour un jeu responsable.' }
    },
    inquiryForm: { name: 'Nom', phone: 'Numéro de téléphone', email: 'E-mail', preferredDates: 'Dates préférées' }
  },
  pl: {
    ...
    footer: { copyright: '© 2026 GORGONA ONE. Oferty premium, zweryfikowane promocje i monetyzacja gotowa do programów partnerskich.', privacy: 'Prywatność', terms: 'Warunki', disclosure: 'Ujawnienie informacji', cookies: 'Pliki cookie', partnerAgreement: 'Umowa partnerska', admin: 'Administracja' },
    admin: { badge: 'Chroniony panel administratora', title: 'Zarządzaj sklepami, kuponami, ofertami bukmacherskimi i analityką', addStores: 'Dodaj sklepy', editCoupons: 'Edytuj kupony', deleteOffers: 'Usuń oferty', importCsv: 'Importuj dane CSV' },
    promoPages: {
      aiReady: { badge: 'Gotowe na AI', title: 'Przyszła infrastruktura asystenta AI', body: 'Baza danych ofert jest zbudowana z myślą o przyszłych rekomendacjach AI, wyszukiwaniu w języku naturalnym oraz konwersacyjnym odkrywaniu ofert.' },
      amazonPromoCodes: { badge: 'Strona SEO', title: 'Kody promocyjne Amazon i ukryte oszczędności', body: 'Znajdź wyselekcjonowane oferty Amazon, darmową dostawę i zweryfikowane okazje rabatowe.' },
      bestShoppingDeals: { badge: 'Strona docelowa SEO', title: 'Najlepsze oferty zakupowe wyselekcjonowane dla premium oszczędności', body: 'Odkryj najnowsze zweryfikowane oferty w modzie, elektronice, domu, podróżach i urodzie.', browseStores: 'Przeglądaj sklepy' },
      betmgmPromos: { badge: 'Strona SEO', title: 'Promocje BetMGM i informacje o bukmacherze', body: 'Dedykowana strona z ofertami BetMGM, dostępnością wg stanu i powiązanymi informacjami.' },
      caesarsPromos: { badge: 'Strona SEO', title: 'Promocje Caesars Sportsbook i szczegóły operatora', body: 'Dedykowana strona z ofertami Caesars Sportsbook i informacjami o przyszłych kodach promocyjnych.' },
      draftkingsPromos: { badge: 'Strona SEO', title: 'Promocje DraftKings i aktualności bukmacherskie', body: 'Dedykowana strona z ofertami związanymi z DraftKings i informacjami o operatorze.' },
      fanduelPromos: { badge: 'Strona SEO', title: 'Promocje FanDuel i aktualności o zakładach', body: 'Dedykowana strona z promocjami bukmachera FanDuel i szczegółami operatora.' },
      fashionDiscounts: { badge: 'Strona SEO', title: 'Zniżki modowe na premium marki i sezonowe nowości', body: 'Przeglądaj oferty modowe łączące styl, jakość i promocje ograniczone czasowo.' },
      nikeCoupons: { badge: 'Strona SEO', title: 'Kupony Nike i premium niezbędniki dla sportowców', body: 'Odkryj zweryfikowane oferty Nike, sezonowe nowości i zniżki na premium odzież.' },
      sportsBettingPromos: { badge: 'Strona SEO', title: 'Promocje zakładów sportowych i oferty bukmacherskie', body: 'Odkryj premium treści związane z bukmacherami, dostępność wg stanu oraz wskazówki dotyczące odpowiedzialnej gry.' }
    },
    inquiryForm: { name: 'Imię', phone: 'Numer telefonu', email: 'E-mail', preferredDates: 'Preferowane daty' }
  }
};
