...
export const translations = {
  en: {
    ...
    ai: {
      ...
      aiNotConnected: "The Discovery Room isn't connected to Gemini yet - add a GEMINI_API_KEY to the environment to bring the AI concierge online. In the meantime, explore Travel, Restaurants, Shopping, Villas, Yachts, Car Rentals, Sportsbooks and Events from the navigation above.",
      aiSnag: 'The concierge hit a snag reaching Gemini just now. Please try again in a moment.',
      aiRateLimited: 'The concierge is getting a lot of requests right now - please try again in a few seconds.',
      aiInvalidKey: 'The concierge Gemini key looks invalid or unauthorized. Please check GEMINI_API_KEY.',
      aiNoReply: "I couldn't quite catch that - could you rephrase?",
      aiTimeout: 'The concierge is taking longer than expected to respond. Please try again in a moment.',
      aiUnavailable: 'The concierge is temporarily unavailable. Please try again shortly.',
  ...
  ru: {
    ...
    ai: {
      ...
      aiNotConnected: 'Комната открытий пока не подключена к Gemini - добавьте GEMINI_API_KEY в окружение, чтобы включить AI-консьержа. А пока изучите разделы Путешествия, Рестораны, Шопинг, Виллы, Яхты, Аренда авто, Ставки и События в навигации выше.',
      aiSnag: 'Консьерж только что не смог связаться с Gemini. Попробуйте ещё раз через момент.',
      aiRateLimited: 'Сейчас консьерж получает очень много запросов - попробуйте снова через несколько секунд.',
      aiInvalidKey: 'Похоже, ключ Gemini у консьержа неверен или не авторизован. Проверьте GEMINI_API_KEY.',
      aiNoReply: 'Не совсем расслышал - не могли бы вы переформулировать?',
      aiTimeout: 'Консьерж отвечает дольше обычного. Попробуйте ещё раз через момент.',
      aiUnavailable: 'Консьерж временно недоступен. Попробуйте немного позже.',
  ...
  es: {
    ...
    ai: {
      ...
      aiNotConnected: 'La Sala de Descubrimiento aún no está conectada a Gemini - añade una GEMINI_API_KEY al entorno para activar el conserje de IA. Mientras tanto, explora Viajes, Restaurantes, Compras, Villas, Yates, Alquiler de autos, Apuestas deportivas y Eventos en la navegación superior.',
      aiSnag: 'El conserje tuvo un problema al contactar a Gemini. Inténtalo de nuevo en un momento.',
      aiRateLimited: 'El conserje está recibiendo muchas solicitudes ahora mismo - inténtalo de nuevo en unos segundos.',
      aiInvalidKey: 'La clave Gemini del conserje parece inválida o no autorizada. Verifica GEMINI_API_KEY.',
      aiNoReply: 'No entendí bien eso - ¿puedes reformularlo?',
      aiTimeout: 'El conserje está tardando más de lo esperado en responder. Inténtalo de nuevo en un momento.',
      aiUnavailable: 'El conserje no está disponible temporalmente. Inténtalo de nuevo en breve.',
  ...
  he: {
    ...
    ai: {
      ...
      aiNotConnected: 'חדר הגילויים עדיין לא מחובר ל-Gemini - הוסיפו GEMINI_API_KEY לסביבה כדי להפעיל את קונסיירז\' ה-AI. בינתיים, גלו את טיולים, מסעדות, קניות, וילות, יאכטות, השכרת רכב, הימורי ספורט ואירועים בתפריט הניווט למעלה.',
      aiSnag: 'לקונסיירז\' הייתה תקלה בהתחברות ל-Gemini הרגע. נסו שוב בעוד רגע.',
      aiRateLimited: 'הקונסיירז\' מקבל כרגע הרבה בקשות - נסו שוב בעוד כמה שניות.',
      aiInvalidKey: 'נראה שמפתח ה-Gemini של הקונסיירז\' אינו תקין או לא מורשה. בדקו את GEMINI_API_KEY.',
      aiNoReply: 'לא הצלחתי להבין את זה בדיוק - תוכלו לנסח מחדש?',
      aiTimeout: 'לקונסיירז\' לוקח יותר זמן מהצפוי להגיב. נסו שוב בעוד רגע.',
      aiUnavailable: 'הקונסיירז\' אינו זמין באופן זמני. נסו שוב בקרוב.',
  ...
  zh: {
    ...
    ai: {
      ...
      aiNotConnected: '发现室尚未连接到 Gemini - 请在环境中添加 GEMINI_API_KEY 以启用 AI 礼宾。与此同时，请通过上方导航探索旅行、餐厅、购物、别墅、游艇、租车、体育博彩和活动。',
      aiSnag: '礼宾刚才连接 Gemini 时遇到问题，请稍后重试。',
      aiRateLimited: '礼宾目前收到大量请求 - 请几秒后重试。',
      aiInvalidKey: '礼宾的 Gemini 密钥似乎无效或未授权，请检查 GEMINI_API_KEY。',
      aiNoReply: '没太听清 - 能否换个说法？',
      aiTimeout: '礼宾响应时间比预期更长，请稍后重试。',
      aiUnavailable: '礼宾服务暂时不可用，请稍后重试。',
  ...
  pt: {
    ...
    ai: {
      ...
      aiNotConnected: 'A Sala de Descobertas ainda não está conectada ao Gemini - adicione uma GEMINI_API_KEY ao ambiente para colocar o concierge de IA online. Enquanto isso, explore Viagens, Restaurantes, Compras, Vilas, Iates, Aluguel de Carros, Casas de Apostas e Eventos na navegação acima.',
      aiSnag: 'O concierge teve um problema ao alcançar Gemini agora. Tente novamente em um momento.',
      aiRateLimited: 'O concierge está recebendo muitos pedidos agora - tente novamente em alguns segundos.',
      aiInvalidKey: 'A chave Gemini do concierge parece inválida ou não autorizada. Verifique GEMINI_API_KEY.',
      aiNoReply: 'Não consegui entender bem - pode reformular?',
      aiTimeout: 'O concierge está demorando mais que o esperado para responder. Tente novamente em um momento.',
      aiUnavailable: 'O concierge está temporariamente indisponível. Tente novamente em breve.',
  ...
  uk: {
    ...
    ai: {
      ...
      aiNotConnected: 'Кімната відкриття ще не підключена до Gemini - додайте GEMINI_API_KEY до середовища, щоб вивести конк\'єржа ШІ в мережу. Тим часом дослідіть Подорожі, Ресторани, Покупки, Вілли, Яхти, Оренду автомобілів, Букмекерські контори та Події у навігації вище.',
      aiSnag: 'Конк\'єрж мав проблему з досягненням Gemini зараз. Спробуйте ще раз за секунду.',
      aiRateLimited: 'Конк\'єрж отримує багато запитів прямо зараз - спробуйте ще раз за кілька секунд.',
      aiInvalidKey: 'Ключ Gemini конк\'єржа виглядає неправильним або неавторизованим. Перевірте GEMINI_API_KEY.',
      aiNoReply: 'Не змогла зрозуміти - можете переформулювати?',
      aiTimeout: 'Конк\'єрж довше, ніж очікується, реагує. Спробуйте ще раз за секунду.',
      aiUnavailable: 'Конк\'єрж тимчасово недоступний. Спробуйте ще раз в найближчому часі.',
  ...
  ja: {
    ...
    ai: {
      ...
      aiNotConnected: 'ディスカバリールームはまだGeminiに接続されていません。AI コンシェルジュをオンラインにするには、GEMINI_API_KEY を环境に追加してください。それまでの間、上記のナビゲーションから旅行、レストラン、ショッピング、ヴィラ、ヨット、レンタカー、スポーツブック、イベントをご覧ください。',
      aiSnag: 'コンシェルジュが今、Geminiに到達する際に問題がありました。しばらくしてからもう一度お試しください。',
      aiRateLimited: 'コンシェルジュは今、多くのリクエストを受けています。数秒後にもう一度お試しください。',
      aiInvalidKey: 'コンシェルジュのGeminiキーは無効または権限がないように見えます。GEMINI_API_KEYを確認してください。',
      aiNoReply: 'よくわかりませんでした。言い直してもらえますか？',
      aiTimeout: 'コンシェルジュの応答が予想より長くかかっています。しばらくしてからもう一度お試しください。',
      aiUnavailable: 'コンシェルジュは一時的に利用できません。もう少しお試しください。',
  ...
  ko: {
    ...
    ai: {
      ...
      aiNotConnected: '디스커버리 룸이 아직 Gemini에 연결되어 있지 않습니다. AI 콘시에르주를 온라인으로 가져오려면 GEMINI_API_KEY를 환경에 추가하세요. 그동안 위 네비게이션에서 여행, 레스토랑, 쇼핑, 빌라, 요트, 자동차 렌탈, 스포츠 베팅 및 이벤트를 살펴보세요.',
      aiSnag: '콘시에르주가 지금 Gemini에 도달하는 데 문제가 있었습니다. 잠시 후 다시 시도해주세요.',
      aiRateLimited: '콘시에르주가 지금 많은 요청을 받고 있습니다. 몇 초 후 다시 시도해주세요.',
      aiInvalidKey: '콘시에르주 Gemini 키가 유효하지 않거나 권한이 없습니다. GEMINI_API_KEY를 확인하세요.',
      aiNoReply: '잘 이해하지 못했습니다. 다시 말씀해주시겠어요?',
      aiTimeout: '콘시에르주가 응답하는 데 예상보다 오래 걸리고 있습니다. 잠시 후 다시 시도해주세요.',
      aiUnavailable: '콘시에르주가 일시적으로 사용할 수 없습니다. 잠시 후 다시 시도해주세요.',
  ...
  de: {
    ...
    ai: {
      ...
      aiNotConnected: 'Der Entdeckungsraum ist noch nicht mit Gemini verbunden. Fügen Sie einen GEMINI_API_KEY zur Umgebung hinzu, um den KI-Concierge online zu bringen. Entdecken Sie in der Zwischenzeit Reisen, Restaurants, Shopping, Villen, Yachten, Mietwagen, Sportwetten und Veranstaltungen in der obigen Navigation.',
      aiSnag: 'Der Concierge hatte gerade ein Problem beim Erreichen von Gemini. Bitte versuchen Sie es in einem Moment erneut.',
      aiRateLimited: 'Der Concierge erhält gerade viele Anfragen — bitte versuchen Sie es in ein paar Sekunden erneut.',
      aiInvalidKey: 'Der Gemini-Schlüssel des Concierge sieht ungültig oder nicht autorisiert aus. Bitte überprüfen Sie GEMINI_API_KEY.',
      aiNoReply: 'Ich konnte das nicht ganz verstehen — könnten Sie es anders formulieren?',
      aiTimeout: 'Der Concierge antwortet länger als erwartet. Bitte versuchen Sie es in einem Moment erneut.',
      aiUnavailable: 'Der Concierge ist vorübergehend nicht verfügbar. Bitte versuchen Sie es in Kürze erneut.',
  ...
  ar: {
    ...
    ai: {
      ...
      aiNotConnected: 'غرفة الاكتشاف غير متصلة بـ Gemini حتى الآن - أضف GEMINI_API_KEY إلى البيئة لإدخال كونسيرج الذكاء الاصطناعي عبر الإنترنت. في الوقت الحالي، استكشف السفر والمطاعم والتسوق والفيلات واليخوت وتأجير السيارات والرهانات الرياضية والفعاليات من التنقل أعلاه.',
      aiSnag: 'واجه الكونسيرج مشكلة في الوصول إلى Gemini الآن. يرجى المحاولة مرة أخرى بعد قليل.',
      aiRateLimited: 'يتلقى الكونسيرج الكثير من الطلبات الآن - يرجى المحاولة مرة أخرى في بضع ثوان.',
      aiInvalidKey: 'يبدو أن مفتاح Gemini للكونسيرج غير صحيح أو غير مصرح به. يرجى التحقق من GEMINI_API_KEY.',
      aiNoReply: 'لم أتمكن من فهم ذلك تماما - هل يمكنك إعادة الصيغة؟',
      aiTimeout: 'يستغرق الكونسيرج وقتًا أطول من المتوقع للرد. يرجى المحاولة مرة أخرى بعد قليل.',
      aiUnavailable: 'الكونسيرج غير متاح مؤقتًا. يرجى المحاولة مرة أخرى في وقت قريب.',
  ...
  tr: {
    ...
    ai: {
      ...
      aiNotConnected: 'Keşif Odası henüz Gemini\'ye bağlanmadı - yapay zeka concierge\'ini çevrimiçi getirmek için ortama bir GEMINI_API_KEY ekleyin. Bu arada, yukarıdaki navigasyondan Seyahat, Restoranlar, Alışveriş, Villalar, Yatlar, Araba Kiralama, Bahis Siteleri ve Etkinlikleri keşfet.',
      aiSnag: 'Concierge şu anda Gemini\'ye ulaşmada bir sorun yaşadı. Lütfen bir süre sonra tekrar deneyin.',
      aiRateLimited: 'Concierge şu anda çok fazla istek alıyor - lütfen birkaç saniye sonra tekrar deneyin.',
      aiInvalidKey: 'Concierge\'in Gemini anahtarı geçersiz veya yetkisiz gibi görünüyor. Lütfen GEMINI_API_KEY\'i kontrol edin.',
      aiNoReply: 'Bunu çok iyi anlamadım - ifade edebilir misiniz?',
      aiTimeout: 'Concierge yanıt vermekte beklenenden daha uzun sürüyor. Lütfen bir süre sonra tekrar deneyin.',
      aiUnavailable: 'Concierge geçici olarak kullanılamaz. Lütfen kısa süre sonra yeniden deneyin.',
  ...
  fa: {
    ...
    ai: {
      ...
      aiNotConnected: 'اتاق کشف هنوز به Gemini متصل نشده است - یک GEMINI_API_KEY به محیط اضافه کنید تا کنسیرژ هوش مصنوعی را آنلاین کنید. در این میان، سفر، رستوران‌ها، خریدها، ویلاها، یخت‌ها، اجاره خودروها، سایت‌های شرط‌بندی و رویدادها را از ناوبری بالا کشف کنید.',
      aiSnag: 'کنسیرژ اکنون مشکلی در دسترسی به Gemini داشت. لطفاً کمی بعد دوباره تلاش کنید.',
      aiRateLimited: 'کنسیرژ اکنون درخواست‌های زیادی دریافت می‌کند - لطفاً چند ثانیه بعد دوباره تلاش کنید.',
      aiInvalidKey: 'کلید Gemini کنسیرژ نامعتبر یا غیرمجاز به نظر می‌رسد. لطفاً GEMINI_API_KEY را بررسی کنید.',
      aiNoReply: 'نتوانستم کاملاً فهم کنم - می‌توانید مجدداً بیان کنید؟',
      aiTimeout: 'کنسیرژ برای پاسخ دادن بیش‌تر از حد انتظار طول می‌کشد. لطفاً کمی بعد دوباره تلاش کنید.',
      aiUnavailable: 'کنسیرژ موقتاً در دسترس نیست. لطفاً کمی بعد دوباره تلاش کنید.',
  ...
  it: {
    ...
    ai: {
      ...
      aiNotConnected: 'La sala di scoperta non è ancora connessa a Gemini - aggiungi un GEMINI_API_KEY all\'ambiente per portare il concierge IA online. Nel frattempo, esplora Viaggi, Ristoranti, Shopping, Ville, Yacht, Noleggio auto, Scommesse sportive ed Eventi dalla navigazione sopra.',
      aiSnag: 'Il concierge ha incontrato un problema nel raggiungere Gemini proprio ora. Riprova tra un momento.',
      aiRateLimited: 'Il concierge sta ricevendo molte richieste adesso - riprova tra pochi secondi.',
      aiInvalidKey: 'La chiave Gemini del concierge sembra non valida o non autorizzata. Controlla GEMINI_API_KEY.',
      aiNoReply: 'Non ho capito bene - potresti riformulare?',
      aiTimeout: 'Il concierge sta impiegando più tempo del previsto per rispondere. Riprova tra un momento.',
      aiUnavailable: 'Il concierge è temporaneamente non disponibile. Riprova tra poco.',
  ...
  fr: {
    ...
    ai: {
      ...
      aiNotConnected: 'La salle de découverte n\'est pas encore connectée à Gemini - ajoutez une GEMINI_API_KEY à l\'environnement pour mettre le concierge IA en ligne. En attendant, explorez Voyage, Restaurants, Shopping, Villas, Yachts, Location de voitures, Paris sportifs et Événements à partir de la navigation ci-dessus.',
      aiSnag: 'Le concierge a rencontré un problème pour atteindre Gemini maintenant. Veuillez réessayer dans un instant.',
      aiRateLimited: 'Le concierge reçoit beaucoup de demandes en ce moment - veuillez réessayer dans quelques secondes.',
      aiInvalidKey: 'La clé Gemini du concierge semble invalide ou non autorisée. Veuillez vérifier GEMINI_API_KEY.',
      aiNoReply: 'Je n\'ai pas bien compris - pourriez-vous reformuler?',
      aiTimeout: 'Le concierge prend plus de temps que prévu pour répondre. Veuillez réessayer dans un instant.',
      aiUnavailable: 'Le concierge est temporairement indisponible. Veuillez réessayer dans un instant.',
  ...
  pl: {
    ...
    ai: {
      ...
      aiNotConnected: 'Pokój odkrycia nie jest jeszcze połączony z Gemini - dodaj GEMINI_API_KEY do środowiska, aby przywieźć concierge\'a sztucznej inteligencji online. W międzyczasie zapoznaj się z Podróżami, Restauracjami, Zakupami, Willami, Jachtami, Wynajmem samochodów, Bukmacherami i Wydarzeniami z powyższej nawigacji.',
      aiSnag: 'Concierge miał problem z dotarciem do Gemini w tej chwili. Spróbuj ponownie za chwilę.',
      aiRateLimited: 'Concierge w tej chwili otrzymuje wiele żądań - spróbuj ponownie za kilka sekund.',
      aiInvalidKey: 'Klucz Gemini concierge\'a wygląda na nieprawidłowy lub nieautoryzowany. Sprawdź GEMINI_API_KEY.',
      aiNoReply: 'Nie do końca zrozumiałem - możesz przeformułować?',
      aiTimeout: 'Concierge trwa dłużej niż oczekiwano na odpowiedź. Spróbuj ponownie za chwilę.',
      aiUnavailable: 'Concierge jest czasowo niedostępny. Spróbuj ponownie za chwilę.',
