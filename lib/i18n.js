...
export const translations = {
  en: {
    nav: { home: 'Home', businesses: 'Businesses', stores: 'Stores', coupons: 'Coupons', rentals: 'Rentals', sportsbook: 'Sportsbook', events: 'Events', admin: 'Admin', dashboard: 'Dashboard', search: 'Search deals' },
    categories: {
