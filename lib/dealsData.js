...
const brandsByCategory = {
  shopping: [
    { name: 'Amazon', domain: 'amazon.com', discount: 'Up to 40% off', promoCode: '', featured: true, affiliateUrl: 'https://www.amazon.com/b?node=53629917011&linkCode=ll2&tag=gorgonaone-20&linkId=05a55e37ed38fba770a7fee5731cbc7d&language=en_US&ref_=as_li_ss_tl' },
  ...
  Object.entries(brandsByCategory).forEach(([category, brands]) => {
    brands.forEach((brand, index) => {
      ...
      deals.push({
        ...
        affiliateLink: brand.affiliateUrl || `https://www.example.com/affiliate/${slug}`,
        website: brand.affiliateUrl || `https://${brand.domain}`,
