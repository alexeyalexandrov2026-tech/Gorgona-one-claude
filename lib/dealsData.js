...
const brandsByCategory = {
  shopping: [
    ...
    { name: 'Kinetix Casual Luxury (KXC)', domain: 'kxclothing.com', discount: 'New season styles', promoCode: '', featured: false, logo: '/images/brands/kinetix-casual-luxury.svg', logoOnSolid: true, affiliateLink: 'https://www.awin1.com/cread.php?awinmid=53985&awinaffid=2982101&ued=https%3A%2F%2Fkxclothing.com%2F' },
  ...
  travel: [
    ...
    { name: 'Rentcars.com', domain: 'rentcars.com', discount: 'Worldwide car rental deals', promoCode: '', featured: false, logo: '/images/brands/rentcars-shopping.svg', affiliateLink: 'https://click.linksynergy.com/fs-bin/click?id=BsBQ7p%2fMcbE&offerid=1791245.3&type=3&subid=0' },
  ...
  Object.entries(brandsByCategory).forEach(([category, brands]) => {
    brands.forEach((brand, index) => {
      ...
      deals.push({
        ...
        slug,
        category,
        logo: brand.logo || `/images/brands/${slug}.${logoExt}`,
        image: brand.logo || `/images/brands/${slug}.${logoExt}`,
        logoOnSolid: brand.logoOnSolid,
