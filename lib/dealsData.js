...
const brandsByCategory = {
  shopping: [
    ...
    { name: 'Sephora', domain: 'sephora.com', discount: 'Member-only deals', promoCode: '', featured: false },
  ...
  Object.entries(brandsByCategory).forEach(([category, brands]) => {
    brands.forEach((brand, index) => {
      ...
      deals.push({
        ...
        description: brand.city
          ? `${brand.name} in ${brand.city}, ${brand.state} - certified kosher, verified deals and optimized affiliate-ready links.`
          : `${brand.name} offers premium savings across ${category} with verified deals and optimized affiliate-ready links.`,
