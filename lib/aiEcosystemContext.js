...
// `id` is the stable key callers use to look up a translated display label
// (lib/i18n.js: t.ai.suggestionTopics[id]) - `label` stays as an English
// fallback only, for when a translation is somehow missing.
const SUGGESTION_TOPICS = [
  { id: 'travel', href: '/travel', label: 'Travel', keywords: ['travel', 'trip', 'destination', 'flight', 'airfare', 'vacation', 'holiday'] },
  { id: 'diningNightlife', href: '/restaurants-nightlife', label: 'Dining & Nightlife', keywords: ['restaurant', 'dinner', 'dining', 'nightlife', 'club', 'steakhouse', 'cocktail', 'lounge', 'reservation', 'table', 'bar'] },
  { id: 'shopping', href: '/stores', label: 'Shopping', keywords: ['shop', 'shopping', 'fashion', 'store', 'discount', 'promo code', 'coupon', 'deal'] },
  { id: 'villasStays', href: '/vacation-rentals', label: 'Villas & Stays', keywords: ['villa', 'stay', 'rental home', 'residence', 'mansion'] },
  { id: 'yachtRentals', href: '/yachts', label: 'Yacht Rentals', keywords: ['yacht', 'boat', 'charter', 'sail'] },
  { id: 'carRentals', href: '/rentals', label: 'Car Rentals', keywords: ['car rental', 'rent a car', 'supercar', 'exotic car', 'drive', 'ferrari', 'lamborghini'] },
  { id: 'sportsbooks', href: '/sportsbook', label: 'Sportsbooks', keywords: ['bet', 'sportsbook', 'wager', 'odds', 'bonus'] },
  { id: 'eventsEntertainment', href: '/events', label: 'Events & Entertainment', keywords: ['event', 'concert', 'show', 'ticket', 'vip', 'experience', 'adrenaline', 'skydiv', 'balloon'] }
];
...
export function matchSuggestions(text, limit = 3) {
  ...
  return scored.slice(0, limit).map(({ id, href, label }) => ({ id, href, label }));
}
