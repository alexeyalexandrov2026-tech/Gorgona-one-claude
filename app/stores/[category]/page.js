  ...
  return (
    <main className="flex-1 py-10">
      <div className="market-shell mb-8 rounded-[2rem] p-8">
        <p className="text-sm uppercase tracking-[0.3em] text-brand-gold">{category.label}</p>
        <h1 className="mt-2 text-3xl font-semibold text-white">{category.label} deals and promo codes</h1>
