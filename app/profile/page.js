    ...
    return (
      <main className="flex-1 py-10">
        <div className="rounded-3xl border border-white/10 bg-white/5 p-8 shadow-premium">
          <p className="text-sm uppercase tracking-[0.3em] text-brand-gold">{t.profileExtra.pill}</p>
  ...
  return (
    <main className="flex-1 py-10">
      <div className="rounded-3xl border border-white/10 bg-white/5 p-8 shadow-premium">
        ...
        <h1 className="mt-2 text-3xl font-semibold text-white">{t.profileExtra.subtitle}</h1>
        <div className="mt-8 grid gap-6 md:grid-cols-3">
          <div className="rounded-2xl border border-white/10 bg-black/40 p-5">
            <p className="text-sm text-zinc-400">{t.profileExtra.savedCoupons}</p>
            <p className="mt-2 text-2xl font-semibold text-brand-gold">12</p>
          </div>
          <div className="rounded-2xl border border-white/10 bg-black/40 p-5">
            <p className="text-sm text-zinc-400">{t.profileExtra.favoriteStores}</p>
            <p className="mt-2 text-2xl font-semibold text-brand-gold">8</p>
          </div>
          <div className="rounded-2xl border border-white/10 bg-black/40 p-5">
            <p className="text-sm text-zinc-400">{t.profileExtra.couponHistory}</p>
