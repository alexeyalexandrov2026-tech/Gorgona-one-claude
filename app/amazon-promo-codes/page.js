...
export default async function AmazonPromoCodesPage() {
  ...
  return (
    <main className="flex-1 py-10">
      <div className="rounded-3xl border border-white/10 bg-white/5 p-8 shadow-premium">
        ...
        <h1 className="mt-2 text-3xl font-semibold text-white">{t.seoPages.amazonTitle}</h1>
        <p className="mt-4 text-zinc-400">{t.seoPages.amazonBody}</p>
      </div>
    </main>
  );
}
