-- ============================================================
-- GORGONA ONE bootstrap: schema.sql + storage.sql + seed.sql
-- combined into one paste for the Supabase SQL Editor.
-- Generated from the individual files - do not edit here,
-- edit database/schema.sql / storage.sql / seed.sql and
-- regenerate. Safe to re-run (idempotent).
-- ============================================================
